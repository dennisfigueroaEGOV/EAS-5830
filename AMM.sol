...
contract AMM is AccessControl{
	...
	*/
	...
	// and sell_quantity should be the amount of that token being traded to the contract. 
	// The contract should calculate the amount of the other token to return to the sender using the 
	// invariant calculation of Uniswap. Learn how it works here
	...
	*/
    ...
    uint256 totalA = ERC20(tokenA).balanceOf(address(this));
    uint256 totalB = ERC20(tokenB).balanceOf(address(this));
    invariant = totalA * totalB;
